...
export const models: { [key: string]: ModelPackage } = {
  ...
  asksagegpt45: {
    ...
    description:
      "Latest OpenAI GPT 4.5 preview model.",
    params: {
  ...
  asksagegroq70b: {
    ...
    asksagellama3: {
    title: "Llama 3 70b",
    description: "Models demonstrate state-of-the-art performance on various industry benchmarks, particularly excelling in areas like instruction following, reasoning, and code generation",
    params: {
      title: "Llama 3 70b",
      model: "llma3",
