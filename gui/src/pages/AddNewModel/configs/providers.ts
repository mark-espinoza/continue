...
To get started, [register](https://dataplatform.cloud.ibm.com/registration/stepone?context=wx) on watsonx SaaS, create your first project and setup an [API key](https://www.ibm.com/docs/en/mas-cd/continuous-delivery?topic=cli-creating-your-cloud-api-key).`,
  ...
  askSage: {
    ...
    packages: [
      ...
      // models.asksageclaude35gov, // Uncomment when available
      models.gemini20Flash,
      models.gemini25Pro,
      models.gpt4o,
      models.gpt4omini,
      models.asksagegpto1mini,
      models.asksagegpto3mini,
      models.asksagegpto1,
      models.asksagegpt35,
      ...
      models.claude3Opus,
      models.claude3Sonnet,
      models.asksageclaude4opus,
      models.asksageclaude4sonnet,
      models.asksageclaude2,
      models.asksageclaude37sonnet,
      models.gpt35turbo,
      models.asksageamazonbedtitan,
      models.grokBeta,
      models.asksagellama4Scout,
      models.asksagegroq70b,
      models.asksagegroqllama33,
      models.asksagellama3,
    ],
